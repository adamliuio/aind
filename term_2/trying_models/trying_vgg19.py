...
"""
	...
	for best performance you should set `image_data_format="channels_last"` in your
...
def VGG19(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000):
	...
	if weights == 'imagenet':
		...
		if include_top:
			weights_path = get_file('/Users/hongru.liu/Code/deep-learning-models/vgg19_weights_tf_dim_ordering_tf_kernels.h5', WEIGHTS_PATH, cache_subdir='models')
		else:
			weights_path = get_file('/Users/hongru.liu/Code/deep-learning-models/vgg19_weights_tf_dim_ordering_tf_kernels_notop.h5', WEIGHTS_PATH_NO_TOP, cache_subdir='models')
...
if __name__ == '__main__':
	...
	img_path = '/Users/hongru.liu/Pictures/porsche-911-wallpaper-1.jpg'
