...
def Xception(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000):
	...
	if weights == 'imagenet':
		if include_top:
			weights_path = get_file('/Users/hongru.liu/Code/deep-learning-models/xception_weights_tf_dim_ordering_tf_kernels.h5',       TF_WEIGHTS_PATH,        cache_subdir='models')
		else:
			weights_path = get_file('/Users/hongru.liu/Code/deep-learning-models/xception_weights_tf_dim_ordering_tf_kernels_notop.h5', TF_WEIGHTS_PATH_NO_TOP, cache_subdir='models')
