...
from keras.layers import Dense, Input, Conv2D, Flatten, MaxPooling2D, GlobalMaxPooling2D, GlobalAveragePooling2D
...
"""
	...
	The model and the weights are compatible with both TensorFlow and Theano. The data format
	...
	# Arguments
		...
		input_shape:
			...
			has to be `(224, 224, 3)` (with `channels_last` data format) or `(3, 224, 244)` (with `channels_first` data format).
...
def VGG16(include_top=True, weights='imagenet', input_tensor=None, input_shape=None, pooling=None, classes=1000):
	...
	if weights == 'imagenet':
		...
		if include_top:
			weights_path = get_file('/Users/hongru.liu/Code/deep-learning-models/vgg16_weights_tf_dim_ordering_tf_kernels.h5',       WEIGHTS_PATH,        cache_subdir='models')
		else:
			weights_path = get_file('/Users/hongru.liu/Code/deep-learning-models/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5', WEIGHTS_PATH_NO_TOP, cache_subdir='models')
...
if __name__ == '__main__':
	...
	img_path = '/Users/hongru.liu/Downloads/tmp/dog.jpg'
...
### include_top=True
# Predicted:
#	('n02085620', 'Chihuahua', 0.9741115),
#	('n02087046', 'toy_terrier', 0.022334537),
#	('n02113186', 'Cardigan', 0.0012724919),
#	('n02113023', 'Pembroke', 0.00037319717),
#	('n02113978', 'Mexican_hairless', 0.00031377899)
